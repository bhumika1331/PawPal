...
class MyPetsViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            } else if segue.identifier == "PetDetailsSegue", let destinationVC = segue.destination as? IndiviualPetDetailViewController {
...
extension MyPetsViewController : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            performSegue(withIdentifier: "PetDetailsSegue", sender: self)
        }
